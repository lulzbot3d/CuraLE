...
class LulzBotPrintersModel(ListModel):
    ...
    LCDRole = Qt.ItemDataRole.UserRole + 3
    LCDDefaultRole = Qt.ItemDataRole.UserRole + 4
    ...
    def __init__(self, parent = None):
        ...
        self.addRoleName(self.LCDDefaultRole, "lcd_default")
    ...
    def _update(self):
        ...
        for metadata in definition_containers:
            ...
            items.append({
                ...
                "lcd_default": metadata.get("lcd_is_standard", True),
