...
class BuildVolume(SceneNode):
    ...
    _tower_settings = ["prime_tower_enable", "prime_tower_size", "prime_tower_position_x", "prime_tower_position_y", "prime_tower_use_from_profile", "prime_tower_use_from_profile_extruder_nr"]
