...
G1 X140 Y-29 Z2.5 F3000                   ; move to open space
M400                                      ; clear buffer
M117 Heating...                           ; LCD status message
M109 R215  T0  				  ; set extruder temp and wait
M109 R215  T1  				  ; set extruder temp and wait
...
G1 X140 Y10 F4000                         ; move above bed to shear off filament
M106 S255                                 ; turn on fan
G4 S7                                     ; wait 7 seconds
M107                                      ; turn off fan
G1 X140 Y-29 Z5.45 F3000                  ; move to open space
T1                                        ; set extruder
G1 E0 F100                                ; undo retraction
G92 E-30                                  ; set extruder negative amount to purge
G1 E0 F100                                ; purge XXmm of filament
