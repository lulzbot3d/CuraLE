...
ComboBox {
    ...
    delegate: ItemDelegate {
        ...
        property bool showSwatch: control.showDropdownSwatch
        ...
        contentItem: Label {
                ...
                background: Rectangle {
                    // This is basically exclusively for adding an optional color swatch...
                    id: delegateAdditional

                    visible: delegateItem.showSwatch
                    ...
                    color: delegateItem.swatchColor
                }
        }
