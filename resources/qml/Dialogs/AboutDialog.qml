    ...
    ScrollView
    {
        ...
        ListView
        {
            ...
            Component.onCompleted:
            {
                ...
                projectsModel.append({ name: "CuraEngine", description: catalog.i18nc("@label", "G-code generator"), license: "AGPLv3", url: "https://gitlab.com/lulzbot3d/cura-le/cura-engine-le" });
