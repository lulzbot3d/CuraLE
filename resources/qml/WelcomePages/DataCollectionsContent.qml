...
Item
{
    UM.Label
    {
        ...
        text: "Help us to improve Cura LulzBot Edition"
    ...
    Item
    {
        ...
        Column
        {
            ...
            UM.Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: "Cura LulzBot Edition collects anonymous data to improve print quality and user experience, including:"
            ...
            UM.Label
            {
                ...
                text:
                {
                    var t = "Data collected by Cura LulzBot Edition will not contain any personal information."
