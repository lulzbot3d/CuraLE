...
Item
{
    ...
    property int propertyStoreIndex: manager ? manager.storeContainerIndex : 6 // definition_changes
    ...
    property string machineStackId: Cura.MachineManager.activeMachine != null ? Cura.MachineManager.activeMachine.id : null
