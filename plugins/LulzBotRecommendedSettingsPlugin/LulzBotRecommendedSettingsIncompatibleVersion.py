...
class LulzBotRecommendedSettingsIncompatibleVersion(Extension):
    HIDE_MESSAGE_PREFERENCE = "recommendedsettings/hide_incompatibility_message"
    ...
    def __init__(self):
        ...
        self._incompatibility_message = Message(
            i18n_catalog.i18nc(
                "@info:status",
                "Using this version of the Recommended Settings plugin with this version of Cura is untested and might cause issues so it is disabled. "
                "An updated version of the plugin may be available on github and/or (soon) in the Marketplace.",
            ),
            title=i18n_catalog.i18nc("@label", "Recommended Settings"),
    ...
    def _onMessageAction(self, message, action) -> None:
        if action=="dismiss":
            ...
            QDesktopServices.openUrl(QUrl("https://github.com/fieldOfView/Cura-TabbedSettingsPlugin/releases"))
