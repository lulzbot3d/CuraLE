    ...
    Flickable {
        ...
        Column {
            ...
            HeatedBedBox {
                ...
                enabled: activePrinter != null && activePrinter.bedTemperature != -1
            ...
            ManualPrinterControl {
                printerModel: activePrinter
                visible: connectedDevice != null
                enabled: activePrinter != null ? activePrinter.canControlManually : false
            }


            MonitorSection {
                label: catalog.i18nc("@label", "Active Print Job")
                width: base.width
                visible: connectedDevice != null
            ...
            MonitorItem {
                label: catalog.i18nc("@label", "Time Elapsed:")
