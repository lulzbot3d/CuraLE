...
class USBPrinterOutputDeviceManager(QObject, OutputDevicePlugin, Extension):
    ...
    def getDefaultFirmwareName(self):
        ...
        lulzbot_machines = {
            ...
            "lulzbot_gladiator_goldenrod":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
            "lulzbot_gladiator_dingy_cutworm":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
            "lulzbot_gladiator_banded_tiger":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
            "lulzbot_gladiator_lutefisk":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
            "lulzbot_gladiator_cecropia":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
            "lulzbot_gladiator_achemon":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
            "lulzbot_gladiator_perca":      "Marlin_ProXT_Universal_2.0.6.5_e3cc1be2.bin",
