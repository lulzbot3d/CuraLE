...
ROOT_URL = f""
ROOT_CURA_URL = f""  # Root of all Marketplace API requests.
ROOT_USER_URL = f""
PACKAGES_URL = f""  # URL to use for requesting the list of packages.
PACKAGE_UPDATES_URL = f""  # URL to use for requesting the list of packages that can be updated.
USER_PACKAGES_URL = f""