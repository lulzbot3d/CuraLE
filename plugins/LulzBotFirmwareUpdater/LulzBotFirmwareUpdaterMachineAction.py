...
class LulzBotFirmwareUpdaterMachineAction(MachineAction):
    """Upgrade the firmware of a machine by USB with this action."""

    def __init__(self) -> None:
        super().__init__("LulzBotUpgradeFirmware", catalog.i18nc("@action", "Update Firmware"))
        self._qml_url = "LulzBotFirmwareUpdaterMachineAction.qml"
